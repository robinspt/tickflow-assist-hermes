...
TOOL_SCHEMAS = {
    ...
    "start_daily_update": schema("start_daily_update", "Start Hermes-thread scheduler for pre-market brief, daily update, and post-close review.", {}),
    "stop_daily_update": schema("stop_daily_update", "Stop TickFlow Assist Hermes-thread scheduled tasks.", {}),
    "daily_update_status": schema("daily_update_status", "Show TickFlow Assist scheduled task status.", {}),
